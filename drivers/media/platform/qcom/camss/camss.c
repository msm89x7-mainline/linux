...
static const struct camss_subdev_resources csiphy_res_8x17[] = {
	/* CSIPHY0 */
	{
		.regulators = {},
		.clock = { "top_ahb", "ispif_ahb", "ahb", "csiphy0_timer" },
		.clock_rate = { { 0 },
				{ 0 },
				{ 0 },
				{ 100000000, 160000000, 200000000, 266670000 } },
		.reg = { "csiphy0", "csiphy0_clk_mux" },
		.interrupt = { "csiphy0" },
		.csiphy = {
			.id = 0,
...
static const struct camss_subdev_resources csid_res_8x17[] = {
	/* CSID0 */
	{
		.regulators = {
...
static const struct camss_subdev_resources ispif_res_8x17 = {
	/* ISPIF */
	.clock = { "top_ahb", "ahb", "ispif_ahb",
		   "csi0", "csi0_pix", "csi0_rdi",
		   "csi1", "csi1_pix", "csi1_rdi",
...
static const struct camss_subdev_resources vfe_res_8x17[] = {
	/* VFE0 */
	{
		.regulators = {},
		.clock = { "top_ahb", "vfe0", "csi_vfe0",
			   "vfe_ahb", "vfe_axi", "ahb" },
		.clock_rate = { { 0 },
				{ 50000000, 80000000, 100000000, 133330000,
				  160000000, 177780000, 200000000, 266670000,
				  308570000, 320000000, 329140000, 360000000 },
				{ 0 },
				{ 0 },
				{ 0 },
				{ 0 } },
...
static const struct camss_subdev_resources csiphy_res_8x37[] = {
	/* CSIPHY0 */
	{
		.regulators = {},
		.clock = { "top_ahb", "ispif_ahb", "ahb", "csiphy0_timer" },
...
static const struct camss_subdev_resources vfe_res_8x37[] = {
	/* VFE0 */
	{
		.regulators = {},
		.clock = { "top_ahb", "vfe0", "csi_vfe0",
			   "vfe_ahb", "vfe_axi", "ahb" },
		.clock_rate = { { 0 },
				{ 50000000, 80000000, 100000000, 133333333,
				  160000000, 177777778, 200000000, 266666667,
				  308571428, 320000000, 360000000, 400000000,
				  432000000 },
				{ 0 },
				{ 0 },
				{ 0 },
...
static const struct camss_subdev_resources csiphy_res_8x52[] = {
	/* CSIPHY0 */
	{
		.regulators = {
			{ .supply = "vdda", .init_load_uA = 40000 }
...
static const struct camss_subdev_resources csid_res_8x52[] = {
	/* CSID0 */
	{
		.regulators = {},
		.clock = { "top_ahb", "ispif_ahb", "csi0_ahb", "ahb",
...
static const struct camss_subdev_resources ispif_res_8x52 = {
	/* ISPIF */
	.clock = { "top_ahb", "ispif_ahb", "ahb",
		   "csi0", "csi0_pix", "csi0_rdi",
		   "csi1", "csi1_pix", "csi1_rdi",
...
static const struct camss_subdev_resources vfe_res_8x52[] = {
	/* VFE0 */
	{
		.regulators = {},
		.clock = { "top_ahb", "vfe0", "csi_vfe0",
...
static const struct camss_resources msm8917_resources = {
	.version = CAMSS_8x17,
	.csiphy_res = csiphy_res_8x17,
	.csid_res = csid_res_8x17,
	.ispif_res = &ispif_res_8x17,
	.vfe_res = vfe_res_8x17,
	.csiphy_num = ARRAY_SIZE(csiphy_res_8x17),
	.csid_num = ARRAY_SIZE(csid_res_8x17),
	.vfe_num = ARRAY_SIZE(vfe_res_8x17),
};

static const struct camss_resources msm8937_resources = {
	.version = CAMSS_8x37,
	.csiphy_res = csiphy_res_8x37,
...
static const struct camss_resources msm8952_resources = {
	.version = CAMSS_8x52,
	.csiphy_res = csiphy_res_8x52,
	.csid_res = csid_res_8x52,
	.ispif_res = &ispif_res_8x52,
	.vfe_res = vfe_res_8x52,
	.csiphy_num = ARRAY_SIZE(csiphy_res_8x52),
	.csid_num = ARRAY_SIZE(csid_res_8x52),
	.vfe_num = ARRAY_SIZE(vfe_res_8x52),
};
...
static const struct of_device_id camss_dt_match[] = {
	...
	{ .compatible = "qcom,msm8917-camss", .data = &msm8917_resources },
	{ .compatible = "qcom,msm8937-camss", .data = &msm8937_resources },
	{ .compatible = "qcom,msm8939-camss", .data = &msm8939_resources },
	{ .compatible = "qcom,msm8952-camss", .data = &msm8952_resources },
